              ...
              bookings.map((item) => (
                <tr>
                    ...
                    <div className="flex items-center gap-3">
                      <div className="flex flex-col">
                        ...
                        <p className="block antialiased font-sans text-sm leading-normal text-blue-gray-900  opacity-70">
                          {item.Hostel[0].city}, {item.Hostel[0].Address}
                        </p>
                        <p className="block antialiased font-sans text-sm leading-normal text-blue-gray-900  opacity-70">
                          {item.Hostel[0].Owner_Phone},{" "}
                          {item.Hostel[0].Owner_Email}
                        </p>
                        <p className="block antialiased font-sans text-sm leading-normal text-blue-gray-900  opacity-70">
                          <a
                            href={item.Hostel[0].Hostel_Location_Link}
                            target="_blank"
                  ...
                  <td className="p-4 border-b border-blue-gray-50">
                    <div className="flex flex-col">
                      <p className="block antialiased font-sans text-sm leading-normal text-blue-gray-900 font-normal">
                        {item.Food[0].Package_Name}
                      </p>
                      <p className="block antialiased font-sans text-sm leading-normal text-blue-gray-900 font-normal opacity-70">
                        {item.Food[0].Meal_Timings}
                      </p>
                      <p className="block antialiased font-sans text-sm leading-normal text-blue-gray-900 font-normal opacity-70">
                        {item.Food[0].Type_of_Meal}
                      </p>
                    </div>
                  </td>
                  <td className="p-4 border-b border-blue-gray-50">
                  ...
                  <td className="p-4 border-b border-blue-gray-50">
                    <button
                      ...
                      title="View Hostel"
                      onClick={() => {
                        navigateTo(`/user/view/${item.Hostel[0]._id}`, {
                          state: item.Hostel[0],
                        });
                      }}
                    >
                    ...
                    <Link to={`/user/feedback/${item.Hostel[0]._id}`} className="p-5 mt-3 text-blue-600 underline">
                     Rate
                    </Link>
                  </td>
                </tr>
