...
const ViewSingleHostelProfile = () => {
  ...
  const item = JSON.parse(sessionStorage.getItem('hostel'));
  ...
  <p>
    <a href={`${url}uploads/Hostel/Profiles/${item.Document_Photo}`} target='_blank' className='text-blue-700 underline'> View Document</a>
          ...
          <div className='flex justify-center p-20'>
           <button className='bg-gray-600 w-full text-white h-8 rounded-lg' 
           onClick={
            ()=>{
...
export default ViewSingleHostelProfile